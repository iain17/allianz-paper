...
\newcommand{\researchQuestionTwo}{``\textit{Wat is de huidige staat van de technologie en hoe kan het worden ingezet voor de claim use cases.}''}
\newcommand{\researchQuestionThree}{``\textit{Uit welke use cases, requirements en concerns bestaat het claim proces van Allianz?}''}
...
\input{chapters/7.currentState}
\input{chapters/8.implementatie}
\input{chapters/9.conclusie}
